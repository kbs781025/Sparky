...
int main()
{
	...
	while (!window.closed())
	{
	...
	#endif
		glm::vec3 newLightPosition = glm::vec3(view * glm::vec4(lightPosition, 1.0f)); // light position in view coordinates
		...
		pLightingShader->setUniform3f("light.position", newLightPosition);
